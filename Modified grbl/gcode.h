...
#define MODAL_GROUP_M10 14 // [M85,M86,M87,M88,M89] extra relay control
...
// Modal Group M10: Extra relay control
#define RELAY_DISABLE 0 // M89 (Default: Must be zero)
#define RELAY_ONE_CHANGE  1 // M85 (NOTE: Uses planner condition bit flag)
#define RELAY_TWO_CHANGE  2 // M86 (NOTE: Uses planner condition bit flag)
#define RELAY_THREE_CHANGE  3 // M87 (NOTE: Uses planner condition bit flag)
#define RELAY_FOUR_CHANGE  4 // M88 (NOTE: Uses planner condition bit flag)
...
typedef struct {
  ...
  uint8_t relay;           // {M10,M11,M12,M13,M14}
