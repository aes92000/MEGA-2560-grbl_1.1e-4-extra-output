...
// Define extra relay enable output pins.
#define RELAY_ONE_DDR   DDRF
#define RELAY_ONE_PORT  PORTF
#define RELAY_ONE_BIT   0 // MEGA2560  Pin A0
#define RELAY_TWO_DDR    DDRF
#define RELAY_TWO_PORT   PORTF
#define RELAY_TWO_BIT    1 // MEGA2560  Pin A1
#define RELAY_FOUR_DDR    DDRF
#define RELAY_FOUR_PORT   PORTF
#define RELAY_FOUR_BIT    2 // MEGA2560  Pin A2 
#define RELAY_THREE_DDR    DDRF
#define RELAY_THREE_PORT   PORTF
#define RELAY_THREE_BIT    3 // MEGA2560  Pin A3 
#define RELAY_MASK ((1<<RELAY_ONE_BIT)|(1<<RELAY_TWO_BIT)|(<<RELAY_FOUR_BIT)|(<<RELAY_THREE_BIT))
